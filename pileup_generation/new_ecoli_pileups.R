setwd("~/Documents/final_s4U_figures/e_coli_anticodon/") #working directory containing reference.fa, reference.fai, and subfolders for each condition containing replicate BAMs + indexes
library(data.table)
library(plyr)
library(tidyverse)
library(Rsamtools)
